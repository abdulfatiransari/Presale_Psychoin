                    ...
                    <tbody>
                        ...
                        <tr>
                            <td className="py-6 px-10  w-[330px] text-center border border-slate-700">
                                ...
                                <span className="text-[24px] font-semibold leading-6">Lightning-Fast Execution</span>
                                <p className="text-[16px] text-[#CDCDCD] mt-4">
                            ...
                            <td className="py-6 px-10  w-[330px] text-center border border-slate-700">
                                ...
                                <span className="text-[24px] font-semibold leading-6">Say Good-bye to Scams</span>
                                <p className="text-[16px] text-[#CDCDCD] mt-4">
                            ...
                            <td className="py-6 px-10  w-[330px] text-center border border-slate-700">
                                ...
                                <span className="text-[24px] font-semibold leading-6">Designed for Tomorrow</span>
                                <p className="text-[16px] text-[#CDCDCD] mt-4">
