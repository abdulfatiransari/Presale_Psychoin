...
export default function Presale() {
    ...
    return (
        <div>
                ...
                <div className="flex justify-center items-center">
                    ...
                    >
                        ...
                        <div className="flex justify-center items-center gap-6 px-16 max-md:px-8 pb-6">
                            <p className="text-[20px] ">Invite your Friends and receive 5% Bonus!</p>
                            <Button
                        ...
                        >
                            <div className="flex justify-center items-center">
                                <Tabs
                                    ...
                                    variant="underlined"
                                    classNames={{
                                        tabList: "w-full relative rounded-none p-0 border-b border-divider gap-[160px]",
                            ...
                            {keys === "crypto" && (
                                <>
                                    <div className="w-full gap-[200px] flex">
                                        <div>
                                            <p className="text-[18px] text-white">{price ? price : "0.01"}</p>
                            ...
                            {keys === "fiat" && (
                                <>
                                    ...
                                    <div className="flex gap-[4px] mb-2">
                                        <span className="text-[16px] text-[#CDCDCD] mt-2">Reciever Address:</span>
                                        <input
            ...
            <SlidingCompanies />
            <Image src={"/img/Line 2.png"} alt="line" width={0} height={0} className="w-full h-[1px] mb-10  mt-12" />
            <BotSections />
            <Token />
            <Graph />
            <Team />
